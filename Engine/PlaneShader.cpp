...
bool PlaneShader::InitStandard(ID3D11Device* device, WCHAR* vsFilename, WCHAR* psFilename)
{
...
bool PlaneShader::SetShaderParameters(ID3D11DeviceContext* context, DirectX::SimpleMath::Matrix* world, DirectX::SimpleMath::Matrix* view, DirectX::SimpleMath::Matrix* projection, Light* sceneLight1, float time, ID3D11ShaderResourceView* texture1)
{
...
void PlaneShader::EnableShader(ID3D11DeviceContext* context)
{
